        ...
        <div className='detailsother'>
          <div className='detailsotherbox'>
            <div className='leftother'>
              <div className='leftothercomp' ><h1>Credit Card/Debit Card</h1></div>
              <div className='leftothercomp'><h1>Net Banking</h1></div>
              <div className='leftothercomp'><h1>UPI</h1></div>
              <div className='leftothercomp'><h1>Wallet</h1></div>
              <div className='leftothercomp'><h1>Cash On Delivery</h1></div>
            </div>
            <div className='rightother'></div>
          </div>
        </div>
      }
      {!detail &&
